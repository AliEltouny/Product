...
export const DRINK_VARIANTS: DrinkVariant[] = [
  {
    ...
    mobileVideoUrl: "https://braszseedmeagubxkkyp.supabase.co/storage/v1/object/public/Products/cherry%201.mp4"
  },
  {
    id: 2,
    name: "GRAPE",
    ...
    mobileVideoUrl: "https://braszseedmeagubxkkyp.supabase.co/storage/v1/object/public/Products/grapes%201.mp4"
  },
  {
    id: 3,
    name: "ORANGE",
    ...
    mobileVideoUrl: "https://braszseedmeagubxkkyp.supabase.co/storage/v1/object/public/Products/orange%201.mp4"
  }
];
